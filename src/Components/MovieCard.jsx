    ...
    return (
        ...
        >
            {watchList.includes(id) ?
                <div onClick={() => handleRemoveFromWatchList(id)} className='text-2xl m-2 py-0.5 rounded cursor-pointer bg-slate-950/50'>&#10060;</div> :
                <div onClick={() => handleAddToWatchList(id)} className='text-2xl m-2 py-0.5 rounded cursor-pointer bg-slate-950/50'>&#128525;</div>
            }
